        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneralDepartmentId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ...
                    TownId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Employees_GeneralDepartments_GeneralDepartmentId1",
                        column: x => x.GeneralDepartmentId1,
                        principalTable: "GeneralDepartments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Employees_Towns_TownId1",
                        column: x => x.TownId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_GeneralDepartmentId1",
                table: "Employees",
                column: "GeneralDepartmentId1");

            migrationBuilder.CreateIndex(
                name: "IX_Employees_TownId1",
                table: "Employees",
                column: "TownId1");
        }
